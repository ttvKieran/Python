...
function Registerpage(){
    ...
    <div className="container">
      ...
      <div className="collapse navbar-collapse" id="navigation" >
        <ul className="navbar-nav mx-auto" >
          ...
          <li className="nav-item">
            <Link to="/profile" className="nav-link me-2" style={{fontSize: 18}}>
              <i className="fa fa-user opacity-6  me-1" />
              Profile
            </Link>
          </li>
          <li className="nav-item">
            <Link to="/login" className="nav-link me-2" style={{fontSize: 18}}>
              <i className="fas fa-user-circle opacity-6  me-1" />
              Sign Up
            </Link>
          </li>
          <li className="nav-item">
            <Link to="/register" className="nav-link me-2" style={{fontSize: 18}}>
  ...
  <main className="main-content  mt-0">
    <div
      ...
      style={{
        backgroundImage:
          'url("https://img.freepik.com/free-vector/character-illustration-people-holding-speech-bubbles_53876-64665.jpg?t=st=1729569349~exp=1729572949~hmac=b19568db0678b27035d113bc3857a6e9a9b81b1c418f2afb420c481d3d203d63&w=900")',
        backgroundPosition: "-1px 890px"
      }}
    >
